/*
Napisati C program koji će ispisati sva putovanja koja zadovoljavaju traženi budžet. Datoteka agencija.dat sadrži
podatke o putovanjima u sljedećem obliku:
...
Potrebno je učitati koliki je budžet (od-do), te ispisati sva putovanja koja su unutar budžeta, poredano po ukupnoj cijeni,
u datoteku dostupno.txt.

Napomena: treba uzeti u obzir i postotak popusta kod izračuna cijene.
